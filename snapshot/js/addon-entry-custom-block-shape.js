"use strict";
(self["webpackChunkGUI"] = self["webpackChunkGUI"] || []).push([["addon-entry-custom-block-shape"],{
...
/* harmony default export */ async function __WEBPACK_DEFAULT_EXPORT__(_ref) {
  ...
  (function (Blockly) {
    ...
    function applyAndUpdate() {
      ...
      (0,_update_all_blocks_js__WEBPACK_IMPORTED_MODULE_0__.updateAllBlocks)(vm, addon.tab.traps.getWorkspace(), BlocklyInstance);
    }
