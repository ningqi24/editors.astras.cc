"use strict";
(self["webpackChunkGUI"] = self["webpackChunkGUI"] || []).push([["addon-entry-astras-copilot"],{
  ...
  (function () {
    ...
    const ScratchDSL = function () {
            ...
            case 'BLOCK':
              {
                ...
                if (atIdx > 0 && tokens[atIdx + 1]) {
                  const _tokens$split = tokens[atIdx + 1].split(','),
                    _tokens$split2 = _slicedToArray(_tokens$split, 2),
                    x = _tokens$split2[0],
                    y = _tokens$split2[1];
      ...
      function loadToWorkspace(dsl, workspace) {
        ...
        const _options$clear = options.clear,
