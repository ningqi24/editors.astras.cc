...
const SharedDispatch = __webpack_require__(/*! ./shared-dispatch */ "../scratch-vm/src/dispatch/shared-dispatch.js");
const log = __webpack_require__(/*! ../util/log */ "../scratch-vm/src/util/log.js");
const _require = __webpack_require__(/*! ../extension-support/tw-extension-worker-context */ "../scratch-vm/src/extension-support/tw-extension-worker-context.js"),
...
const ScratchCommon = __webpack_require__(/*! ./tw-extension-api-common */ "../scratch-vm/src/extension-support/tw-extension-api-common.js");
const createScratchX = __webpack_require__(/*! ./tw-scratchx-compatibility-layer */ "../scratch-vm/src/extension-support/tw-scratchx-compatibility-layer.js");
const dispatch = __webpack_require__(/*! ../dispatch/worker-dispatch */ "../scratch-vm/src/dispatch/worker-dispatch.js");
const log = __webpack_require__(/*! ../util/log */ "../scratch-vm/src/util/log.js");
const _require = __webpack_require__(/*! ./tw-extension-worker-context */ "../scratch-vm/src/extension-support/tw-extension-worker-context.js"),
  isWorker = _require.isWorker;
const createTranslate = __webpack_require__(/*! ./tw-l10n */ "../scratch-vm/src/extension-support/tw-l10n.js");
...
Object.assign(__webpack_require__.g.Scratch, ScratchCommon, {
...
__webpack_require__.g.ScratchExtensions = createScratchX(__webpack_require__.g.Scratch);
...
const ScratchBlocksConstants = __webpack_require__(/*! ../engine/scratch-blocks-constants */ "../scratch-vm/src/engine/scratch-blocks-constants.js");
...
const ArgumentType = __webpack_require__(/*! ./argument-type */ "../scratch-vm/src/extension-support/argument-type.js");
const BlockType = __webpack_require__(/*! ./block-type */ "../scratch-vm/src/extension-support/block-type.js");
const BlockShape = __webpack_require__(/*! ./tw-block-shape */ "../scratch-vm/src/extension-support/tw-block-shape.js");
const TargetType = __webpack_require__(/*! ./target-type */ "../scratch-vm/src/extension-support/target-type.js");
const Cast = __webpack_require__(/*! ../util/cast */ "../scratch-vm/src/util/cast.js");
const external = __webpack_require__(/*! ./tw-external */ "../scratch-vm/src/extension-support/tw-external.js");
const Scratch = {
  ArgumentType,
  BlockType,
  BlockShape,
...
/***/ "../scratch-vm/src/extension-support/tw-extension-worker-context.js"
/*!**************************************************************************!*\
  !*** ../scratch-vm/src/extension-support/tw-extension-worker-context.js ***!
  \**************************************************************************/
(module) {
...
jQuery.ajax = async (arg1, arg2) => {
  ...
  try {
    if (options.dataType === 'jsonp') {
      ...
      __webpack_require__.g[callbackName] = data => {
...
const ArgumentType = __webpack_require__(/*! ./argument-type */ "../scratch-vm/src/extension-support/argument-type.js");
const BlockType = __webpack_require__(/*! ./block-type */ "../scratch-vm/src/extension-support/block-type.js");
const _require = __webpack_require__(/*! ./tw-scratchx-utilities */ "../scratch-vm/src/extension-support/tw-scratchx-utilities.js"),
...
const Color = __webpack_require__(/*! ../util/color */ "../scratch-vm/src/util/color.js");
...
(() => {
/*!************************************************************************************************************************************************************************************************************************************************!*\
  !*** ../../node_modules/.pnpm/babel-loader@8.3.0_@babel+core@7.29.7_supports-color@8.1.1__webpack@5.106.2/node_modules/babel-loader/lib/index.js??ruleSet[1].rules[0]!../scratch-vm/src/extension-support/tw-iframe-extension-worker-entry.js ***!
  \************************************************************************************************************************************************************************************************************************************************/
const context = __webpack_require__(/*! ./tw-extension-worker-context */ "../scratch-vm/src/extension-support/tw-extension-worker-context.js");
const jQuery = __webpack_require__(/*! ./tw-jquery-shim */ "../scratch-vm/src/extension-support/tw-jquery-shim.js");
...
__webpack_require__(/*! ./extension-worker */ "../scratch-vm/src/extension-support/extension-worker.js");
