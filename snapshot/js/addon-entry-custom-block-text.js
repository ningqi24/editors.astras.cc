"use strict";
(self["webpackChunkGUI"] = self["webpackChunkGUI"] || []).push([["addon-entry-custom-block-text"],{
...
/* harmony default export */ async function __WEBPACK_DEFAULT_EXPORT__(_ref) {
  ...
  const updateBlockly = () => {
    ...
    (0,_middle_click_popup_module_js__WEBPACK_IMPORTED_MODULE_1__.clearTextWidthCache)();
    (0,_custom_block_shape_update_all_blocks_js__WEBPACK_IMPORTED_MODULE_0__.updateAllBlocks)(vm, addon.tab.traps.getWorkspace(), blocklyInstance);
  };
