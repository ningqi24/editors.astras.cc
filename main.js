(function() {
    ...
    const i18n = {
        'zh-CN': {
            ...
            'mirrorTitle': '镜像加速',
            'mirrorDesc': '本站为 AstraEditor 非官方镜像站，通过 CDN 加速、视频压缩、懒加载等技术优化访问速度。编辑器正式版自动跳转至官方网站，快照版由本站直接提供。',
        ...
        'en': {
            ...
            'mirrorTitle': 'Mirror Acceleration',
            'mirrorDesc': 'This is an unofficial mirror of AstraEditor, optimized with CDN acceleration, video compression, and lazy loading. The stable editor redirects to the official site; the snapshot version is served directly.',
